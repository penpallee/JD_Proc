...
namespace JD_Proc.ICam
{
    ...
    public class IrDirectInterface
    {
        ...
        public ThermalPaletteImage GetThermalPaletteImage()
        {
            ...
            CheckResult(IrDirectInterfaceInvoke.evo_irimager_multi_get_thermal_palette_image_metadata(InstanceId, _thermalWidth, _thermalHeight, 
                                                                                                      thermalImage, paletteImage.Width, paletteImage.Height, bmpData.Scan0, out metadata));
